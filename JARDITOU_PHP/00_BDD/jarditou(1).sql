...
--
-- Hôte : 127.0.0.1:3308
-- Généré le : lun. 08 fév. 2021 à 07:46
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `us_nom` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `us_prenom` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `us_mail` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `us_login` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `us_pass` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `us_role` tinyint(1) NOT NULL DEFAULT '0',
  `us_d_regis` datetime NOT NULL,
  `us_d_lastco` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`us_id`)
...
INSERT INTO `users` (`us_id`, `us_nom`, `us_prenom`, `us_mail`, `us_login`, `us_pass`, `us_role`, `us_d_regis`) VALUES
(9, 'Bué', 'Adrien', 'adr.bue@hotmail.com', 'adr.bue@hotmail.com', '$2y$10$xnKw5pD8eH9bNFM8RnoA1OsO.oOAVT8yT0PLOuVPinirhiJPLMWIW', 1, '2021-02-07 18:59:18');
